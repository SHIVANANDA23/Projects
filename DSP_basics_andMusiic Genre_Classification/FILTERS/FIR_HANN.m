...
% Design FIR filter using a Hanning window
hanning_window = hann(filter_order+1);
fir_filter = fir1(filter_order, passband_frequency_range / (Fs/2), 'bandpass', hanning_window);

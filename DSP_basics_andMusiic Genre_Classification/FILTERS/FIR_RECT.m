...
% Design FIR filter using a rectangular window
rectangular_window = rectwin(filter_order+1);
fir_filter = fir1(filter_order, passband_frequency_range / (Fs/2), 'bandpass', rectangular_window);
